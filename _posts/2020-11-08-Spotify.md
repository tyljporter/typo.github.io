...
Now that we have a JSON output stored that contains all of my 'liked' songs, it's time to grab the contents of the 'poppostpunkcore' playlist.
...
<img src="{{ site.url }}{{ site.baseurl }}/images/SpotifyURI.jpg" alt="Get spotify platlist URI">
