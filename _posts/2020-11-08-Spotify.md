...
## Overview
Utilizing Python and the Spotipy library alongside the Spotify API, I pulled the contents of the 'poppostpunkcore' playlist as the data sample. Using the same tools, I pulled the contents of my 'liked' library.

Once the dataset was aggregated using Pandas, it was output into a .csv file to be ingested into [Orange](https://orange.biolab.si/) for further preprocessing, visualization, and model creation and evaluation.
