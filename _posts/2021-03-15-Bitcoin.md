...
To prepare our data to be used in ML models, the first step is to utilize a sklearn vectorizer. Our X dataset will be our sentences, and our Y dataset will be our manual classifications.
